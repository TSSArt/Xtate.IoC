...
#region Interface IStateMachineSessionId
	...
	public void AddServices(IServiceCollection services)
	{
		...
		services.AddForwarding<IStateMachineSessionId>(self);
		services.AddForwarding<IStateMachineLocation>(self);
		services.AddForwarding<ICaseSensitivity>(self);
		services.AddForwarding<IExternalServiceInvokeId>(self);
		services.AddForwarding<IExternalServiceType>(self);
