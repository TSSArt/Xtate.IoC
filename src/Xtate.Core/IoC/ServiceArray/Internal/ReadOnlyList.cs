...
namespace Xtate.IoC.ServiceArray.Internal;
...
#region Interface IReadOnlyList<T>
	...
	private static NotSupportedException ReadOnlyCollectionException() => new(Resources.Exception_ThisCollectionIsReadOnlyAndCannotBeModified);
