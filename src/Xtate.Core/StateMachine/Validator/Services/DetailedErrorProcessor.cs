...
namespace Xtate.StateMachine.Validator.Services;

/// <summary>
///     Aggregates all errors and throw single exception with previously added errors
/// </summary>
[InstantiatedByIoC]
public class DetailedErrorProcessor(SessionId? sessionId) : IErrorProcessor
{
...
#region Interface IErrorProcessor
	...
	public void ThrowIfErrors()
	{
		if (_errors is { } errors)
		{
			...
			throw new StateMachineValidationException(errors.ToImmutable(), sessionId);
		}
	}
