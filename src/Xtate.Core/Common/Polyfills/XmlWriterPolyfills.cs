...
internal static class XmlWriterPolyfills
{
	extension(XmlWriter xmlWriter)
	{
		public ConfiguredAwaitable ConfigureAwait(bool continueOnCapturedContext) => new(xmlWriter, continueOnCapturedContext);
