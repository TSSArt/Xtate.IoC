...
internal static class Infra
{
	...
	[AssertionMethod]
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void RequiresNonNegative(long parameter, [CallerArgumentExpression(nameof(parameter))] string? parameterName = null)
	{
		if (parameter < 0)
		{
			ThrowOutOfRangeException(parameterName, parameter, min: 0, long.MaxValue);
		}
	}
