...
public static class BucketExtensions
{
	...
	public static ServiceId? GetServiceId<TKey>(this in Bucket bucket, TKey key) where TKey : notnull =>
		TryGetServiceId(bucket, key, out var serviceId) ? serviceId : null;
