...
[InstantiatedByIoC]
public class PersistedStateMachineNode(DocumentIdNode documentIdNode, IStateMachine stateMachine) : StateMachineNode(documentIdNode, stateMachine), IStoreSupport
{
