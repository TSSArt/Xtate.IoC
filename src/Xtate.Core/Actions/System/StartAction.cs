...
public class StartAction : AsyncAction
{
	...
	public required Deferred<ITaskMonitor> TaskMonitor { private get; [SetByIoC] init; }
	...
	protected override async ValueTask Execute()
	{
		...
		var locationStateMachine = new LocationStateMachine(StateMachineLocation.Location, location) { SessionId = sessionId };
