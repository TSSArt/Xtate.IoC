...
using Xtate.IoC;
using Xtate.ResourceLoaders.File.DependencyInjection;
using Xtate.ResourceLoaders.Resx.DependencyInjection;
using Xtate.ResourceLoaders.Services;
using Xtate.ResourceLoaders.Web.DependencyInjection;
