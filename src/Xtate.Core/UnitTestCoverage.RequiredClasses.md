# Xtate.Core Unit-Test Coverage Gaps

Source: `src/Xtate.Core/UnitTestCoverage.xml`

Generated from `Xtate.Core.dll` module coverage. Classes with 100% aggregate line and block coverage are excluded.
Compiler-generated closure, async, and iterator coverage entries are folded into their declaring class.

Module summary: line coverage 59.66%, block coverage 60.82%; lines not covered 7160; blocks not covered 12552.
Classes requiring additional coverage: 461.

| Class | Line % | Block % | Uncovered lines | Partial lines | Uncovered blocks | Functions |
|---|---:|---:|---:|---:|---:|---:|
| `Xtate.Scxml.Services.ScxmlSerializerWriter` | 3.81 | 4.03 | 391 | 1 | 500 | 38 |
...
| `Xtate.DataTypes.DataModelValue` | 59.27 | 51.29 | 182 | 36 | 395 | 98 |
| `Xtate.DataTypes.DataModelList` | 75.48 | 70.54 | 182 | 21 | 251 | 110 |
...
| `Xtate.DataTypes.DataModelList.Dynamic` | 0 | 0 | 100 | 0 | 138 | 10 |
| `Xtate.DataTypes.DataModelNumber` | 58.8 | 50.59 | 96 | 28 | 251 | 70 |
| `Xtate.ExtDictionary<TKey, TValue>` | 37.41 | 31.96 | 88 | 3 | 132 | 24 |
| `Xtate.ResourceLoaders.Internal.DelegatedStream` | 12.5 | 14.97 | 84 | 0 | 142 | 44 |
| `Xtate.ExtCollection<TValue1, TValue2>` | 9.34 | 11.54 | 82 | 1 | 92 | 9 |
...
| `Xtate.IoProcessors.Http.Internal.QueryStringHelper` | 0 | 0 | 67 | 0 | 72 | 3 |
...
| `Xtate.BitConverterPolyfills` | 0 | 0 | 60 | 0 | 63 | 10 |
...
| `Xtate.DataTypes.DataModelValue.Dynamic` | 0 | 0 | 56 | 0 | 67 | 8 |
...
| `Xtate.IoProcessors.Http.Internal.CounterStream` | 0 | 0 | 52 | 0 | 90 | 17 |
...
| `Xtate.Scxml.Internal.TextContentReader` | 0 | 0 | 47 | 0 | 64 | 38 |
...
| `Xtate.Actions.ActionBase` | 16.67 | 13.04 | 43 | 4 | 100 | 6 |
...
| `Xtate.LazyTask<T>` | 0 | 0 | 39 | 0 | 37 | 5 |
...
| `Xtate.ResourceLoaders.Resource` | 52.44 | 50.91 | 38 | 2 | 54 | 9 |
| `Xtate.Scxml.Services.ScxmlDirector` | 93.31 | 95.9 | 36 | 7 | 73 | 231 |
| `Xtate.IoC.ServiceArray.Internal.ReadOnlyList<T>` | 8.75 | 9.21 | 36 | 1 | 69 | 35 |
| `Xtate.ResourceLoaders.Extensions.StreamExtensions` | 2.7 | 2.99 | 36 | 0 | 65 | 3 |
...
| `Xtate.DataTypes.DataModelList.KeyValueByKeyEnumerator` | 0 | 0 | 36 | 0 | 34 | 5 |
| `Xtate.Persistence.Services.KeyListPersistingController<T>` | 31 | 21.79 | 34 | 1 | 61 | 3 |
| `Xtate.Persistence.Internal.Encode` | 50.74 | 31.62 | 33 | 1 | 80 | 5 |
...
| `Xtate.Scxml.XIncludeException` | 0 | 0 | 31 | 0 | 62 | 6 |
| `Xtate.ExternalServices.SmtpClient.Services.SmtpClientService` | 0 | 0 | 30 | 0 | 82 | 1 |
| `Xtate.ResourceLoaders.Internal.InjectedCancellationStream` | 18.42 | 16.67 | 30 | 2 | 80 | 14 |
...
| `Xtate.DataTypes.DataModelList.ValueByKeyEnumerator` | 0 | 0 | 30 | 0 | 36 | 6 |
...
| `Xtate.ExternalServices.ExternalServiceBase` | 0 | 0 | 27 | 0 | 42 | 8 |
| `Xtate.Persistence.Services.StateMachineReader` | 62.19 | 81.78 | 26 | 249 | 133 | 43 |
| `Xtate.StateMachineHost.Services.ExternalCommunication` | 0 | 0 | 26 | 0 | 55 | 4 |
...
| `Xtate.IoProcessors.NamedPipe.NamedPipeIoProcessorOptions` | 0 | 0 | 25 | 0 | 35 | 5 |
...
| `Xtate.IoProcessors.NamedPipe.Internal.DelayedTries` | 0 | 0 | 24 | 0 | 26 | 4 |
...
| `Xtate.StateMachineHost.RouterEvent` | 0 | 0 | 23 | 0 | 27 | 3 |
...
| `Xtate.StateMachine.Internal.SegmentedName` | 60.32 | 72.65 | 22 | 6 | 32 | 5 |
...
| `Xtate.IoProcessors.Http.HttpIoProcessorOptions` | 0 | 0 | 21 | 0 | 18 | 5 |
| `Xtate.Scxml.Services.XmlBaseReader` | 64.52 | 63.92 | 20 | 4 | 35 | 8 |
| `Xtate.ExtCollection` | 0 | 0 | 20 | 0 | 34 | 3 |
| `Xtate.StateMachine.EventName` | 81.58 | 83.78 | 19 | 4 | 30 | 28 |
| `Xtate.Scxml.Services.XmlDirector` | 75 | 83.33 | 19 | 0 | 17 | 5 |
| `Xtate.DataModel.Services.DefaultForEachEvaluator` | 41.18 | 39.71 | 18 | 4 | 41 | 5 |
...
| `System.Collections.Concurrent.ConcurrentDictionaryPolyfills` | 0 | 0 | 18 | 0 | 23 | 3 |
...
| `System.IO.StreamReaderPolyfills` | 0 | 0 | 16 | 0 | 26 | 1 |
| `Xtate.IoProcessors.Http.Internal.ReadLimitStream` | 0 | 0 | 16 | 0 | 19 | 3 |
| `Xtate.DataTypes.DataModelList.AdapterBase` | 66 | 66.67 | 16 | 2 | 10 | 5 |
| `Xtate.DataModel.XPath.Services.XPathLocationExpression` | 38.46 | 50 | 16 | 0 | 8 | 4 |
| `Xtate.FullUri` | 16.67 | 13.33 | 15 | 0 | 39 | 11 |
| `Xtate.StateMachineFluentBuilder.StateMachineFluentBuilder` | 61.54 | 61.45 | 15 | 0 | 32 | 15 |
| `Xtate.DataModel.Services.DataConverter` | 78.71 | 84.54 | 15 | 13 | 30 | 11 |
| `Xtate.StateMachine.InvokeEntity` | 44.44 | 59.38 | 15 | 0 | 26 | 4 |
| `Xtate.DataModel.XPath.Internal.NodeAdapter` | 42.59 | 38.46 | 15 | 1 | 16 | 15 |
| `Xtate.DataTypes.DataModelList.EntryByKeyEnumerator` | 56.94 | 57.69 | 15 | 1 | 11 | 6 |
...
| `Xtate.DataModel.Services.DefaultExternalDataExpressionEvaluator` | 0 | 0 | 13 | 0 | 31 | 3 |
...
| `Xtate.StateMachine.Validator.StateMachineValidationException` | 40.91 | 39.29 | 13 | 0 | 17 | 2 |
...
| `Xtate.Http.JsonHttpContent` | 0 | 0 | 12 | 0 | 16 | 5 |
| `Xtate.Http.XmlHttpContent` | 0 | 0 | 12 | 0 | 16 | 5 |
...
| `Xtate.DataModel.Null.Services.NullDataModelHandler` | 45.45 | 38.78 | 11 | 2 | 30 | 7 |
| `Xtate.Scxml.Services.XmlDirector.Policy.ValidationContext<TDirector, TEntity>` | 80.41 | 83.54 | 11 | 7 | 27 | 8 |
| `Xtate.StateMachine.LazyId` | 80.33 | 76.92 | 11 | 2 | 21 | 15 |
| `Xtate.StateMachine.StateMachineEntity` | 42.11 | 54.35 | 11 | 0 | 21 | 4 |
| `Xtate.DataModel.Runtime.Services.RuntimeDataModelHandler` | 62.07 | 42.86 | 11 | 0 | 20 | 5 |
| `Xtate.StateMachine.Validator.Services.DetailedErrorProcessor` | 0 | 0 | 11 | 0 | 13 | 3 |
...
| `Xtate.DataTypes.DataModelList.KeyValue` | 30.77 | 3.7 | 9 | 0 | 26 | 7 |
...
| `Xtate.StateMachine.FinalEntity` | 30.77 | 55.17 | 9 | 0 | 13 | 4 |
| `Xtate.Persistence.Services.InMemoryStorageProvider` | 30.77 | 42.86 | 9 | 0 | 12 | 4 |
| `Xtate.StateMachine.TransitionEntity` | 35.71 | 66.67 | 9 | 0 | 12 | 3 |
| `Xtate.StateMachineHost.ScheduledEvent` | 0 | 0 | 9 | 0 | 12 | 5 |
| `Xtate.Actions.AsyncAction.Location` | 0 | 0 | 8 | 0 | 20 | 5 |
...
| `Xtate.DataModel.Null.Services.NullConditionExpressionEvaluator` | 11.11 | 14.29 | 8 | 0 | 12 | 4 |
| `Xtate.StateMachine.DataEntity` | 38.46 | 55.56 | 8 | 0 | 12 | 4 |
| `Xtate.StateMachine.HistoryEntity` | 27.27 | 50 | 8 | 0 | 11 | 4 |
...
| `Xtate.DataTypes.DataModelList.KeyValueByKeyEnumerable` | 0 | 0 | 8 | 0 | 7 | 4 |
| `Xtate.DataTypes.DataModelList.ValueByKeyEnumerable` | 0 | 0 | 8 | 0 | 7 | 4 |
| `Xtate.StateMachine.Builder.Services.AssignBuilder` | 68 | 76.47 | 8 | 0 | 4 | 6 |
| `Xtate.IoC.Tools.DisposeToken` | 22.22 | 12 | 7 | 0 | 22 | 9 |
...
| `Xtate.StateMachine.EventDescriptors` | 53.12 | 50 | 7 | 1 | 18 | 16 |
| `Xtate.Interpreter.Internal.InvokeIdSet` | 63.64 | 57.89 | 7 | 2 | 16 | 7 |
| `Xtate.DataTypes.DataModelList.KeyEnumerator` | 0 | 0 | 7 | 0 | 15 | 7 |
| `Xtate.IoProcessors.Http.Internal.WriteLimitStream` | 0 | 0 | 7 | 0 | 14 | 3 |
| `Xtate.DataModel.XPath.Internal.ItemNodeAdapter` | 82.79 | 83.33 | 7 | 7 | 13 | 10 |
| `Xtate.ExternalServices.HttpClient.Internal.HttpClientServiceOptions` | 0 | 0 | 7 | 0 | 13 | 2 |
...
| `Xtate.DataTypes.LazyValue` | 65 | 61.9 | 7 | 0 | 8 | 4 |
| `Xtate.DataTypes.DataModelDateTime` | 90.29 | 82.8 | 6 | 21 | 43 | 61 |
| `Xtate.DataTypes.DataModelList.Entry` | 82.86 | 11.9 | 6 | 0 | 37 | 11 |
| `Xtate.DataModel.Runtime.Runtime` | 62.5 | 41.67 | 6 | 0 | 28 | 11 |
...
| `Xtate.StateMachine.Target` | 59.38 | 55.56 | 6 | 1 | 16 | 16 |
| `Xtate.DataModel.Services.DefaultContentBodyEvaluator` | 63.89 | 55.17 | 6 | 1 | 13 | 3 |
| `Xtate.DataModel.Services.DefaultInlineContentEvaluator` | 63.89 | 55.17 | 6 | 1 | 13 | 3 |
...
| `Xtate.StateMachine.ParamEntity` | 40 | 63.16 | 6 | 0 | 7 | 3 |
| `Xtate.DataTypes.DataModelList.KeyValuePairEnumerator` | 72.73 | 76 | 6 | 0 | 6 | 5 |
| `Xtate.Interpreter.Services.DataModelValueEntityParser` | 0 | 0 | 6 | 0 | 6 | 1 |
| `Xtate.StateMachine.DoneDataEntity` | 25 | 60 | 6 | 0 | 6 | 3 |
...
| `Xtate.StateMachine.Identifier` | 79.69 | 93.88 | 6 | 1 | 3 | 10 |
| `Xtate.DisposingToken` | 82.35 | 94.29 | 6 | 0 | 2 | 4 |
...
| `Xtate.CancellationTokenRegistrationExtensions` | 0 | 0 | 5 | 0 | 5 | 2 |
| `Xtate.DataTypes.DataModelList.KeyValueEnumerator` | 81.48 | 78.26 | 5 | 0 | 5 | 5 |
| `Xtate.StateMachine.ContentEntity` | 37.5 | 64.29 | 5 | 0 | 5 | 3 |
| `Xtate.DataModel.XPath.Internal.XPathStripRootsIterator` | 76.09 | 84.62 | 5 | 1 | 4 | 5 |
| `Xtate.StateMachine.DataModelEntity` | 16.67 | 50 | 5 | 0 | 4 | 3 |
| `Xtate.StateMachine.ElseIfEntity` | 16.67 | 42.86 | 5 | 0 | 4 | 3 |
| `Xtate.StateMachine.InitialEntity` | 16.67 | 42.86 | 5 | 0 | 4 | 3 |
| `Xtate.StateMachine.OnEntryEntity` | 16.67 | 50 | 5 | 0 | 4 | 3 |
| `Xtate.StateMachine.OnExitEntity` | 16.67 | 50 | 5 | 0 | 4 | 3 |
| `Xtate.DataTypes.DataModelList.EntryEnumerator` | 81.48 | 81.25 | 5 | 0 | 3 | 6 |
| `Xtate.Scxml.Services.ScxmlDirector.XmlLineInfo` | 0 | 0 | 5 | 0 | 3 | 2 |
| `Xtate.Scxml.Services.XIncludeReader.Strings` | 50 | 50 | 4 | 0 | 16 | 8 |
| `Xtate.StateMachine.SendId` | 43.75 | 36 | 4 | 1 | 16 | 8 |
...
| `Xtate.Actions.SyncAction.Location` | 43.75 | 50 | 4 | 1 | 10 | 5 |
...
| `Xtate.Interpreter.CommunicationException` | 0 | 0 | 4 | 0 | 8 | 4 |
| `Xtate.Interpreter.PlatformException` | 0 | 0 | 4 | 0 | 8 | 4 |
...
| `Xtate.DataModel.Services.DefaultLogEvaluator` | 71.43 | 76.67 | 4 | 0 | 7 | 2 |
| `Xtate.DataTypes.DataModelList.KeyEnumerable` | 0 | 0 | 4 | 0 | 7 | 4 |
...
| `Xtate.DataModel.Runtime.RuntimeAction` | 50 | 50 | 4 | 0 | 4 | 2 |
| `Xtate.DataModel.Runtime.RuntimePredicate` | 55.56 | 55.56 | 4 | 0 | 4 | 3 |
| `Xtate.DataModel.Runtime.RuntimeValue` | 60 | 63.64 | 4 | 0 | 4 | 4 |
...
| `Xtate.DataModel.Services.UnknownDataModelHandler` | 0 | 0 | 3 | 0 | 12 | 3 |
...
| `Xtate.DataTypes.DataModelList.ValueEnumerator` | 83.33 | 70.83 | 3 | 1 | 7 | 6 |
...
| `Xtate.DataModel.XPath.XPathDataModelException` | 0 | 0 | 3 | 0 | 6 | 3 |
| `Xtate.Persistence.PersistenceException` | 0 | 0 | 3 | 0 | 6 | 3 |
| `Xtate.StateMachineHost.Exceptions.StateMachineSecurityException` | 0 | 0 | 3 | 0 | 6 | 3 |
| `Xtate.DataModel.Services.ExternalDataExpressionEvaluator` | 0 | 0 | 3 | 0 | 5 | 3 |
...
| `Xtate.ExternalServices.ExternalServiceProviderBase<TService>` | 33.33 | 12.5 | 2 | 0 | 14 | 3 |
...
| `Xtate.StateMachine.SessionId` | 73.08 | 76.92 | 2 | 3 | 9 | 13 |
| `Xtate.DataModel.XPath.Internal.XPathSingleElementIterator` | 72.22 | 46.67 | 2 | 1 | 8 | 5 |
| `Xtate.DataModel.XPath.Internal.DataModelXPathNavigator.Node` | 90.48 | 79.41 | 2 | 0 | 7 | 16 |
| `Xtate.DataTypes.DataModelList.ValueAdapter` | 91.3 | 77.42 | 2 | 0 | 7 | 9 |
...
| `Xtate.Actions.AsyncAction.ArrayValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.AsyncAction.BooleanValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.AsyncAction.IntegerValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.AsyncAction.ObjectValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.SyncAction.ArrayValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.SyncAction.BooleanValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.SyncAction.IntegerValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.Actions.SyncAction.StringValue` | 0 | 0 | 2 | 0 | 5 | 2 |
| `Xtate.DataTypes.DataModelList.KeyValueAdapter` | 89.13 | 80.77 | 2 | 1 | 5 | 9 |
| `Xtate.Interpreter.Model.DataNode` | 86.67 | 84.85 | 2 | 0 | 5 | 8 |
| `Xtate.Interpreter.Model.ParamNode` | 83.33 | 72.22 | 2 | 0 | 5 | 7 |
| `Xtate.Interpreter.Model.SendNode` | 87.5 | 84.85 | 2 | 0 | 5 | 16 |
| `Xtate.Actions.AsyncAction` | 60 | 60 | 2 | 0 | 4 | 5 |
| `Xtate.Actions.SyncAction` | 90.91 | 90.91 | 2 | 0 | 4 | 8 |
| `Xtate.Class.ScxmlStreamStateMachine` | 0 | 0 | 2 | 0 | 4 | 2 |
| `Xtate.DataModel.Runtime.RuntimeAction.ActionAsync` | 0 | 0 | 2 | 0 | 4 | 2 |
| `Xtate.DataModel.Runtime.RuntimePredicate.EvaluatorAsync` | 0 | 0 | 2 | 0 | 4 | 2 |
| `Xtate.DataModel.Runtime.RuntimeValue.EvaluatorAsync` | 0 | 0 | 2 | 0 | 4 | 2 |
| `Xtate.DataModel.XPath.XPathFunctionBase` | 71.43 | 60 | 2 | 0 | 4 | 5 |
| `Xtate.DataTypes.DataModelList.EntryByKeyEnumerable` | 75 | 42.86 | 2 | 0 | 4 | 4 |
| `Xtate.DataTypes.DataModelList.EntryEnumerable` | 50 | 42.86 | 2 | 0 | 4 | 4 |
| `Xtate.DataTypes.DataModelList.KeyValueEnumerable` | 50 | 42.86 | 2 | 0 | 4 | 4 |
| `Xtate.DataTypes.DataModelList.KeyValuePairEnumerable` | 50 | 42.86 | 2 | 0 | 4 | 4 |
| `Xtate.DataTypes.DataModelList.ValueEnumerable` | 50 | 42.86 | 2 | 0 | 4 | 4 |
| `Xtate.DataTypes.LazyValue.NoArg` | 0 | 0 | 2 | 0 | 4 | 2 |
| `Xtate.Interpreter.Model.AssignNode` | 75 | 75 | 2 | 0 | 4 | 8 |
| `Xtate.Interpreter.Model.CancelNode` | 60 | 60 | 2 | 0 | 4 | 5 |
| `Xtate.Interpreter.Model.DoneDataNode` | 88.24 | 90.24 | 2 | 0 | 4 | 7 |
| `Xtate.Interpreter.Model.ElseIfNode` | 80 | 69.23 | 2 | 0 | 4 | 5 |
| `Xtate.Interpreter.Model.ElseNode` | 75 | 55.56 | 2 | 0 | 4 | 4 |
| `Xtate.Interpreter.Model.ForEachNode` | 71.43 | 71.43 | 2 | 0 | 4 | 7 |
| `Xtate.Interpreter.Model.IfNode` | 60 | 60 | 2 | 0 | 4 | 5 |
| `Xtate.Interpreter.Model.LogNode` | 60 | 60 | 2 | 0 | 4 | 5 |
| `Xtate.Interpreter.Model.OnEntryNode` | 80 | 71.43 | 2 | 0 | 4 | 5 |
| `Xtate.Interpreter.Model.OnExitNode` | 80 | 71.43 | 2 | 0 | 4 | 5 |
| `Xtate.Interpreter.Model.RaiseNode` | 50 | 50 | 2 | 0 | 4 | 4 |
| `Xtate.Interpreter.Model.TransitionNode` | 94.12 | 92.98 | 2 | 0 | 4 | 13 |
| `Xtate.Interpreter.OwnedXtateException` | 66.67 | 60 | 2 | 0 | 4 | 6 |
| `Xtate.Interpreter.StateMachineUnhandledErrorException` | 33.33 | 33.33 | 2 | 0 | 4 | 3 |
...
| `Xtate.Persistence.StateMachineSuspendedException` | 33.33 | 33.33 | 2 | 0 | 4 | 3 |
| `Xtate.StateMachine.Internal.IdGenerator` | 66.67 | 69.23 | 2 | 0 | 4 | 6 |
| `Xtate.DataModel.Services.DefaultForEachEvaluator.IndexObject` | 0 | 0 | 2 | 0 | 3 | 2 |
| `Xtate.Interpreter.Model.DataModelNode` | 77.78 | 72.73 | 2 | 0 | 3 | 4 |
...
| `Xtate.Actions.AsyncAction.Value` | 75 | 37.5 | 1 | 0 | 5 | 3 |
| `Xtate.Actions.SyncAction.Value` | 75 | 37.5 | 1 | 0 | 5 | 3 |
| `Xtate.DataModel.Services.DataModelHandlerService` | 90 | 79.17 | 1 | 0 | 5 | 1 |
| `Xtate.DataModel.Services.InlineContentEvaluator` | 75 | 50 | 1 | 0 | 5 | 4 |
| `Xtate.ExternalServices.ExternalServiceProviderBase` | 0 | 0 | 1 | 0 | 5 | 1 |
| `Xtate.Forward` | 0 | 0 | 1 | 0 | 4 | 1 |
...
| `Xtate.CancellationTokenRegistrationExtensions.ConfiguredAwaitable` | 0 | 0 | 1 | 0 | 3 | 1 |
...
| `Xtate.StateMachine.InvokeId` | 90 | 92.5 | 1 | 2 | 3 | 12 |
| `Xtate.StateMachine.SendEntity` | 96.77 | 96.15 | 1 | 0 | 3 | 4 |
...
| `Xtate.ExternalServices.HttpClient.Services.HttpClientService.Provider` | 0 | 0 | 1 | 0 | 2 | 1 |
| `Xtate.ExternalServices.SmtpClient.Services.SmtpClientService.Provider` | 0 | 0 | 1 | 0 | 2 | 1 |
| `Xtate.Interpreter.StateMachineDestroyedException` | 66.67 | 66.67 | 1 | 0 | 2 | 3 |
...
| `Xtate.DataModel.Services.AssignEvaluator` | 85.71 | 92.31 | 1 | 0 | 1 | 7 |
| `Xtate.DataModel.Services.CancelEvaluator` | 75 | 85.71 | 1 | 0 | 1 | 4 |
| `Xtate.DataModel.Services.CustomActionEvaluator` | 85.71 | 92.31 | 1 | 0 | 1 | 7 |
| `Xtate.DataModel.Services.ForEachEvaluator` | 83.33 | 90.91 | 1 | 0 | 1 | 6 |
| `Xtate.DataModel.Services.IfEvaluator` | 75 | 85.71 | 1 | 0 | 1 | 4 |
| `Xtate.DataModel.Services.LogEvaluator` | 75 | 85.71 | 1 | 0 | 1 | 4 |
| `Xtate.DataModel.Services.RaiseEvaluator` | 66.67 | 80 | 1 | 0 | 1 | 3 |
| `Xtate.DataModel.Services.ScriptEvaluator` | 75 | 85.71 | 1 | 0 | 1 | 4 |
| `Xtate.DataModel.Services.SendEvaluator` | 93.33 | 96.55 | 1 | 0 | 1 | 15 |
| `Xtate.DataTypes.DataModelValue.ObjectContainer` | 66.67 | 91.67 | 1 | 0 | 1 | 3 |
| `Xtate.DateTimeExtensions` | 90 | 91.67 | 1 | 0 | 1 | 1 |
| `Xtate.Interpreter.Model.ScriptNode` | 75 | 85.71 | 1 | 0 | 1 | 4 |
| `Xtate.Interpreter.Services.NoStateMachineArguments` | 0 | 0 | 1 | 0 | 1 | 1 |
| `Xtate.StateMachine.ExternalDataExpression` | 83.33 | 85.71 | 1 | 0 | 1 | 3 |
| `Xtate.StateMachine.ExternalScriptExpression` | 83.33 | 85.71 | 1 | 0 | 1 | 3 |
| `Xtate.StateMachine.ScriptExpression` | 83.33 | 85.71 | 1 | 0 | 1 | 3 |
...
| `Xtate.Interpreter.Internal.EntityQueue<T>` | 87.5 | 69.23 | 0 | 2 | 4 | 2 |
| `Xtate.Interpreter.Services.AssemblyTypeInfo` | 62.5 | 76.47 | 0 | 3 | 4 | 1 |
...
| `Xtate.Actions.SyncAction.TypedValue<T>` | 83.33 | 70 | 0 | 1 | 3 | 3 |
...
| `Xtate.DataModel.XPath.Services.XPathContentBodyEvaluator` | 75 | 81.82 | 0 | 1 | 2 | 2 |
| `Xtate.DataModel.XPath.Services.XPathInlineContentEvaluator` | 75 | 81.82 | 0 | 1 | 2 | 2 |
| `Xtate.Interpreter.Internal.OrderedSet<T>` | 98.84 | 96.3 | 0 | 1 | 2 | 9 |
...
| `Xtate.Ancestor.AncestorArray` | 50 | 80 | 0 | 1 | 1 | 1 |
| `Xtate.DataModel.Services.ActionProvider<TCustomAction>` | 97.22 | 97.14 | 0 | 1 | 1 | 4 |
| `Xtate.DataModel.Services.CaseSensitivity` | 75 | 80 | 0 | 1 | 1 | 1 |
| `Xtate.DataModel.Services.ContentBodyEvaluator` | 87.5 | 90 | 0 | 1 | 1 | 4 |
| `Xtate.DataModel.Services.DefaultScriptEvaluator` | 92.86 | 93.75 | 0 | 1 | 1 | 2 |
| `Xtate.DataModel.XPath.XPathFunctionProviderBase<TXPathFunction>` | 75 | 90 | 0 | 1 | 1 | 2 |
...
| `Xtate.StateMachine.CancelEntity` | 87.5 | 92.86 | 0 | 2 | 1 | 3 |
