...
namespace Xtate.StateMachineOptions;
...
public class StateMachineOptions
{
	...
	public TimeSpan DestroyOnIdleTimeout { get; set; } = Timeout.InfiniteTimeSpan;

	public bool XIncludeAllowed { get; set; } = false;

	public int XIncludeMaxNestingLevel { get; set; } = 16;
}