...
public class ExecutableContentMachines : IScxmlTestSource
{
	...
	{
		yield return new ScxmlTestCase("XPath/ExecutableContent/AssignExpressionControlsTransition", AssignExpressionControlsTransition, ExpectedFinalData: "assigned");
		yield return new ScxmlTestCase("XPath/ExecutableContent/IfFirstTrueBranchWins", IfFirstTrueBranchWins, ExpectedFinalData: "first");
		yield return new ScxmlTestCase("XPath/ExecutableContent/IfElseBranchRunsWhenNoConditionMatches", IfElseBranchRunsWhenNoConditionMatches, ExpectedFinalData: "else");
		yield return new ScxmlTestCase("XPath/ExecutableContent/MultipleOnEntryActionsRunInDocumentOrder", MultipleOnEntryActionsRunInDocumentOrder, ExpectedFinalData: "123");
		yield return new ScxmlTestCase("XPath/ExecutableContent/ParentChildEntryOrderIsAncestorBeforeDescendant", ParentChildEntryOrderIsAncestorBeforeDescendant, ExpectedFinalData: "parent-entry;child-entry;");
	}
}
