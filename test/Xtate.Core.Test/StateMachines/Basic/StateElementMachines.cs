...
#region Interface IScxmlTestSource
	...
	{
		yield return new ScxmlTestCase(Name: "Basic/States/InitialChildTransitionIsHonored", InitialChildTransitionIsHonored, ExpectedFinalData: "initial-child");
		yield return new ScxmlTestCase(Name: "Basic/States/InitialTransitionActionsRunInDocumentOrder", InitialTransitionActionsRunInDocumentOrder, ExpectedFinalData: "123");
		yield return new ScxmlTestCase(Name: "Basic/States/InitialTransitionCanEnterNestedDescendant", InitialTransitionCanEnterNestedDescendant, ExpectedFinalData: "nested-descendant");
		yield return new ScxmlTestCase(Name: "Basic/States/FinalDoneDataWithExpression", FinalDoneDataWithExpression, ExpectedFinalData: "expr-done-data");
	}
