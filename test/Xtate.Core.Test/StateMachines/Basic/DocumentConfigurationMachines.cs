...
public class DocumentConfigurationMachines : IScxmlTestSource
{
	...
	{
		yield return new ScxmlTestCase("Basic/DocumentConfiguration/RootInitialTargetsParallelDescendants", RootInitialTargetsParallelDescendants, ExpectedFinalData: "parallel-initial");
		yield return new ScxmlTestCase("Basic/DocumentConfiguration/RootInitialTargetEntersAncestorAndDefaultDescendant", RootInitialTargetEntersAncestorAndDefaultDescendant, ExpectedFinalData: "ancestor-default");
		yield return new ScxmlTestCase("Basic/DocumentConfiguration/BindingDefaultIsEarly", BindingDefaultIsEarly, ExpectedFinalData: "early-default");
		yield return new ScxmlTestCase("Basic/DocumentConfiguration/MissingDataModelUsesPlatformDefault", MissingDataModelUsesPlatformDefault, ExpectedFinalData: "default-datamodel");
	}
}
