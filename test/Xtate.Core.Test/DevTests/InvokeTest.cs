...
public class InvokeTest
{
	...
	public async Task SimpleTest()
	{
		...
		await eventQueueWriter.Dispatch(CreateEventObject(name: "fromInvoked", InvokeId.FromString(invokeId: "invoke_id", invokeUniqueId)), CancellationToken.None);
		await eventQueueWriter.Dispatch(CreateEventObject("ToF"), CancellationToken.None);
		await task;
