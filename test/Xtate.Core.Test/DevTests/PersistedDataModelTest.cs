...
public class PersistedDataModelTest
{
	...
	private DataModelValue GetPlatform()
	{
		...
		list.AddInternal(key: "property.Name", value: "property.Value", DataModelAccess.Constant);
	...
	private DataModelValue GetIoProcessors()
	{
		...
		var value = new DataModelList(DataModelAccess.ReadOnly, caseInsensitive: true);
		value.AddInternal(key: @"location", value: "io://some", DataModelAccess.Constant);
		list.AddInternal(key: "ioProcessor", value, DataModelAccess.Constant);
