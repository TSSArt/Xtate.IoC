...
public class ScxmlToDomTest
{
	...
	{
		Assert.ThrowsExactly<StateMachineValidationException>([ExcludeFromCodeCoverage]() =>
	...
	{
		Assert.ThrowsExactly<StateMachineValidationException>([ExcludeFromCodeCoverage]() =>
																  GetStateMachineWithRoot(
																	  "<datamodel><data id='a'/><data id='b'></data><data id='c' src='c-src/><data id='d' expr='d-expr'/><data id='e'>e-body</data></datamodel>"));
	}
