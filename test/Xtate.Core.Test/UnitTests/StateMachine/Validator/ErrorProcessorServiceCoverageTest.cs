...
public class ErrorProcessorServiceCoverageTest
{
	...
	public void AddErrorUsesEntityLineInfoThenXmlExceptionThenLocationlessFallback()
	{
		...
		service.AddError(new LineInfo(hasLineInfo: true, lineNumber: 11, linePosition: 12), message: "entity line", entityException);
		service.AddError(
			new LineInfo(hasLineInfo: false, lineNumber: 21, linePosition: 22), message: "xml line", new XmlException(message: "xml", innerException: null, lineNumber: 31, linePosition: 32));
		service.AddError(entity: null, message: "plain", new XmlException("no line"));
		...
		Assert.AreEqual(expected: "entity line", processor.Items[0].Message);
