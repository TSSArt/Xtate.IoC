...
public class HttpClientFactoryCoverageTest
{
	...
	private static object? GetActiveEntry(HttpClientFactory factory) => typeof(HttpClientFactory).GetField(name: "_activeEntry", BindingFlags.Instance | BindingFlags.NonPublic)!.GetValue(factory);
}