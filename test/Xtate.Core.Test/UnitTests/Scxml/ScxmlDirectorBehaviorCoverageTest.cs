...
public class ScxmlDirectorBehaviorCoverageTest
{
	...
	public void LineInfoAndErrorForwardingPreserveReaderPositionAndAncestor()
	{
		...
		var createLineInfo = typeof(ScxmlDirector).GetMethod(name: "CreateXmlLineInfo", BindingFlags.Instance | BindingFlags.NonPublic)!;
	...
	private static void SetProperty(ScxmlDirector director, string name, object? value) => typeof(ScxmlDirector).GetProperty(name)!.SetValue(director, value);
}